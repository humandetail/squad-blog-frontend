import type { AboutUsData, BlogrollData, CategoriesData, PageResponseType, PostDetail, PostItem, Settings, TagsData } from '~/types/response'
 ...
 * 获取友情链接列表
 */
export const getBlogroll = () => useRequest<PageResponseType<BlogrollData>>(`${PREFIX}/blogrolls`, { key: 'BLOGROLLS' })
